...
LetterEvents.registerLetterRules(event => {
    event.createAI('first_gift_kjs', 'lonesome', 
        ...
        .trigger(ResourceLocation.fromNamespaceAndPath('touhou_little_maid_contact', 'first_gift_trigger'))
        .once()
        .minAffection(0)
        .maxAffection(500)
        .cooldown(100)
    ...
    event.createPreset('welcome_letter', 
        ...
        'contact:default', 
        'contact:letter')
        .trigger(ResourceLocation.fromNamespaceAndPath('touhou_little_maid_contact', 'player_join'))
        .repeat()
        .minAffection(20)
        .cooldown(1000)
        .register()
    ...
    event.create()
        ...
        .trigger(ResourceLocation.fromNamespaceAndPath('touhou_little_maid_contact', 'story/mine_stone'))
        .trigger(ResourceLocation.fromNamespaceAndPath('touhou_little_maid_contact', 'story/mine_diamond'))
        .once()
        .minAffection(30)
        .maxAffection(80)
        .cooldown(600)
