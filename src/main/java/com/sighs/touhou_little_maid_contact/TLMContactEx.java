...
public class TLMContactEx implements ILittleMaid {
    ...
    public void registerTaskData(TaskDataRegister register) {
        TaskDataKey<CompoundTag> key = register.register(new ResourceLocation(TLMContact.MODID, "maid_letter_state"), CompoundTag.CODEC);
        MaidLetterRuntime.setDataKey(key);
    }
